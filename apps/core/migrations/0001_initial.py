    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('published', models.CharField(choices=[('no', 'Нет'), ('yes', 'Да')], default='yes', max_length=3, verbose_name='Опубликован')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.IntegerField(choices=[(5, '★★★★★'), (4, '★★★★☆'), (3, '★★★☆☆'), (2, '★★☆☆☆'), (1, '★☆☆☆☆')], verbose_name='Рейтинг')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Дата создания')),
                ('published', models.CharField(choices=[('checking', 'На проверке'), ('yes', 'Опубликован'), ('no', 'Отклонён')], default='checking', max_length=8, verbose_name='Статус отзыва')),
